...
Route::prefix('/')->name('admin.')->group(function () {
    ...
    Route::middleware(['authadmin'])->group(function () {
        ...
        Route::get('/dashboard', [HomeController::class, 'restaurantDashboard'])->name('restaurant.dashboard');
        ...
        // lookups
        Route::get('lookup/{type}', [LookupsController::class, 'index'])->name('lookup.index');
        Route::get('lookup/add/{type}', [LookupsController::class, 'add'])->name('lookup.add');
        Route::post('lookup/store/{type}', [LookupsController::class, 'store'])->name('lookup.store');
