    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            ...
            <form method="POST" action="{{ route('admin.acl.store') }}">
                ...
                <div class="mb-3">
                    <label>Route</label>
                    <input type="text" name="route" class="form-control" value="{{ old('route') }}" placeholder="e.g., users.index">
                    @error('route')
                ...
                <div class="mb-3">
                    <label>Icon</label>
                    <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="e.g., fa fa-user">
                </div>
                ...
                <div id="permissions-container">
                    <div class="row mb-2 permission-row">
                        <div class="col-md-5">
                            <input type="text" name="permissions[0][name]" class="form-control" placeholder="Permission Name (e.g. user-list)">
                        </div>
                        <div class="col-md-5">
                            <input type="text" name="permissions[0][function_name]" class="form-control" placeholder="Function Name (e.g. index)">
                        </div>
                        <div class="col-md-2">
