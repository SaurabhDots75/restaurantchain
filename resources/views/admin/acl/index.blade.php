    ...
    <div class="dashboard-panel">
        <div class="role-management">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select name="parent_id" class ="form-control select2init">
                                    ...
                                    @foreach ($parent_list as $list)
                                        <option value="{{ $list->parent_id }}">{{ AclparentByName($list->parent_id) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="tablescroll-tableroll">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm"
                                    href="{{ route('admin.acl.edit', base64_encode($module->id)) }}">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>

                                <a id="delete-recordacl{{ $module->id }}" data-id="{{ $module->id }}"
                                    href="javascript:void(0)" class="btn btn-danger btn-sm delete-btnacl">
                ...
                @include('components.pagination', ['paginator' => $modules])
            </div>
        </div>
    </div>
