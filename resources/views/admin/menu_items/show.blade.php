        ...
        <div class="showuser">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        <strong>Email:</strong>
                        <span class="emailusername">{{ $restaurant->email ?? 'N/A' }}</span>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        <a href="{{ $restaurant->website_url ?? '#' }}"
                            target="_blank">{{ $restaurant->website_url ?? 'N/A' }}</a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        @if ($restaurant->cover_image)
                            <img src="{{ asset('storage/' . $restaurant->cover_image) }}" alt="Cover Image"
                                style="max-width: 200px;">
                        @else
                            N/A
                        @endif
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                    <div class="form-group">
                        ...
                        {{ $restaurant->created_at->format('d-M-Y h:i:s A') ?? 'N/A' }}
                        <!-- Format created at or return 'N/A' -->
                    </div>
                </div>
            </div>
        </div>
