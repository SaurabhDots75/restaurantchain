        ...
        <form method="POST" action="{{ route('admin.food_items.update', $menuItem->id) }}" enctype="multipart/form-data">
            ...
            <div class="edituserform-row">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name', $menuItem->name) }}" placeholder="Enter food item name">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="price" class="form-control" value="{{ old('price', $menuItem->price) }}" placeholder="Enter price">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    @if ($menuItem->image)
                        <img src="{{ asset('storage/' . $menuItem->image) }}" alt="Food Image" class="mt-2" style="max-width: 200px;">
                    @endif
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="is_veg" class="form-control">
                        <option value="1" {{ old('is_veg', $menuItem->is_veg) == 1 ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('is_veg', $menuItem->is_veg) == 0 ? 'selected' : '' }}>No</option>
                    </select>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" name="preparation_time" class="form-control" value="{{ old('preparation_time', $menuItem->preparation_time) }}" placeholder="Enter preparation time">
                </div>

                <!-- Stock Quantity -->
                <div class="form-group mb-3">
                    <label><strong>Stock Quantity:</strong></label>
                    <input type="number" name="stock_quantity" class="form-control" value="{{ old('stock_quantity', $menuItem->stock_quantity) }}" placeholder="Enter stock quantity">
                </div>
