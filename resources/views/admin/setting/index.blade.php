...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            ...
            <a class="view-btn" href="{{ route('admin.home') }}"><i class="fa fa-arrow-left"></i> Back</a>
...
<div class="edituserform adminsetting-form">
@if (isset($setting))
        ...
        @endif
            ...
            <div class="edituserform-row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 adminaddress">
                    <div class="form-group">
