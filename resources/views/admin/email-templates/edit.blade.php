...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mt-10 bg-white p-6 rounded-lg shadow">
        <form action="{{ route('admin.email-templates.update', $emailTemplate->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                        ...
                        @foreach($emailTemplate->variables as $variable)
                            <div class="flex gap-2">
                                ...
                                <button type="button" onclick="removeVariableField(this)"
                                        class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md transition">-</button>
                            </div>
                        @endforeach
                    @endif
                    <div class="flex gap-2">
