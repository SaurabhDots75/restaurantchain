        ...
        <form method="POST" action="{{ route('admin.restaurants.store') }}">
            ...
            <div class="edituserform-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="Restaurant Name" class="form-control" value="{{ old('name') }}">
                </div>

                <div class="form-group">
                    <strong>Address:</strong>
                    <input type="text" name="address" placeholder="Restaurant Address" class="form-control" value="{{ old('address') }}">
                </div>
