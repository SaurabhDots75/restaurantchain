    ...
    <div class="container">
        <div class="header-sec">
            ...
            <div class="search-desktop">	
                <div class="aws-container" data-url="/?wc-ajax=aws_action" data-siteurl="https://www.printit4less.com" data-lang="" data-show-loader="true" data-show-more="false" data-show-page="true" data-ajax-search="true" data-show-clear="false" data-mobile-screen="false" data-use-analytics="false" data-min-chars="1" data-buttons-order="1" data-timeout="300" data-is-mobile="false" data-page-id="18" data-tax=""><form class="aws-search-form" action="https://www.printit4less.com/" method="get" role="search">
                    <div class="aws-wrapper"><input type="search" name="" id="" value="" class="aws-search-field" placeholder="Search" autocomplete="">
                        <input type="hidden" name="post_type" value="product"><input type="hidden" name="type_aws" value="true"></div></form></div>							</div>
            <div class="right-utility">

                <div class="head-right-box">
                        <a href="#"><img class="head-icon" src="images/contact-us.png" data-src="" alt=""><strong>Contact us</strong></a>
                </div>

                <div class="head-right-box">
                    <a href="#"><img class="head-icon" src="images/shop-user.png" data-src="" alt=""><strong>My Account</strong></a>
                </div>

            <div class="head-right-box">
                <a href="#"><img class="head-icon" src="images/cart.png" data-src="" alt=""><strong>Basket</strong></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fa-solid fa-angle-down"></i>Products by Industry
            </a>
            <div class="dropdown-menu">
              <ul>
...
<div class="banner">
    <img src="images/banner.jpg" data-src="" alt="Invoice Forms"></a>
</div>

<div class="heading-box">
<div class="headings"><h1>Featured Products and Offers</h1>
...
<div class="featured-box">
    ...
    <div class="featured-item">
        <div class="featured-thumb">
            <a href="#">
            <img src="images/INVOICESv2.jpg" data-src="" alt="Invoice Forms"></a>
        </div>
    ...
    <div class="featured-item">
        <div class="featured-thumb">
            <a href="#">
            <img src="images/INVOICESv2.jpg" data-src="" alt="Invoice Forms" class="img-fluid lazyloaded" height="500" width="500"></a>
        </div>
        <div class="featured-content">
            <p><a href="#">Invoice Forms</a>
            Starting at $47.00                                 </p>
...
<section class="middle">
    <div class="print-home-form">
        <div class="print-top-point-inner">
            <a href="#">
                <div class="print-top-box">
                    <img class=" lazyloaded" src="images/home-form-icon-1.png" data-src="" alt="" height="50" width="58">
                    <h4>Custom Forms</h4>
               </div>
           </a>
           ...
           <a href="#">
            <div class="print-top-box">
                <img class=" lazyloaded" src="images/home-form-icon-2.png" data-src="" alt="" height="50" width="58">
                <h4>Invoice Forms</h4>
           </div>
       </a>
       ...
       <a href="#">
        <div class="print-top-box">
            <img class=" lazyloaded" src="images/home-form-icon-3.png" data-src="" alt="" height="50" width="58">
    ...
    <a href="#">
        <div class="print-top-box">
            <img class=" lazyloaded" src="images/home-form-icon-4.png" data-src="" alt="" height="50" width="58">
    ...
    <section class="sale-block">
        <div class="sale-tag">
    <img decoding="async" class=" ls-is-cached lazyloaded" src="images/hp-saletag.jpg" alt="Sale!" width="110" height="66" src="">
...
<img src="images/Drop-Box.png" alt="" title="">
</div>
<div class="middlehome-logo">
<img src="images/fpl_logo.png" alt="" title="">
</div>
<div class="middlehome-logo">
<img src="images/American-Legion.png" alt="" title="">
</div>
<div class="middlehome-logo">
<img src="images/Toyota-removebg-preview.png" alt="" title="">
</div>
<div class="middlehome-logo">
<img src="images/Habitat_for_Humanity-removebg-preview.png" alt="" title="">
</div>
<div class="middlehome-logo">
<img src="images/Spencers-removebg-preview.png" alt="" title="">
</div>
