    ...
    <div class="row">
        ...
        <div class="col-lg-10 content-area">
            <div class="mid-section-home">
                ...
                <div class="quotes-proof-contact">
                    <h1>Quotes & Proofs</h1>
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="contact-form-sec">
                                ...
                                <div class="quote-filed">
                                    <label>Address</label>
                                    <input class="input-box" placeholder="Address">
                                </div>

                                <div class="quote-filed">
                                    <label>Zip</label>
                                    <input class="input-box" placeholder="Zip">
                                </div>

                                <div class="quote-filed">
                                    <label>Project Type</label>
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Business Forms</option>
                                        <option value="1">Tags</option>
                                        <option value="2">Labels</option>
                                        <option value="3">Business Cards</option>
                                        <option selected>Door Hangers</option>
                                        <option value="1">Brochures</option>
                                        <option value="2">Post Cards</option>
                                ...
                                <div class="quote-filed">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>No Numbering</option>
                                        <option value="1">Red Ink</option>
                                        <option value="2">Black Ink</option>
                                    </select>
                                </div>
                                ...
                                <div class="quote-filed">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>8.5x11</option>
                                        <option value="1">8.5x5.5</option>
                                ...
                                <div class="quote-filed">
                                    ...
                                    <input class="input-box" placeholder="Quantity">
                                </div>
                                ...
                                <div class="quote-filed">
                                    <label>IAdditional Information</label>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="contact-form-sec">
                                ...
                                <div class="quote-filed">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>1 part copy paper</option>
                                        <option value="1">Carbonless 2-Part</option>
                                        <option value="2">Carbonless 3-Part</option>
                                        <option value="2">Carbonless 4-Part</option>
                                    </select>
                                </div>
                                ...
                                <div class="quote-filed">
                                    <label>Books?</label>
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>No books</option>
                                        <option value="1">Books of 50</option>
                                        <option value="2">Pads of 50</option>
                                    </select>
                                </div>
                                ...
                                <div class="quote-filed">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>One Sided</option>
                                ...
                                <div class="quote-filed">
                                    ...
                                    <select class="form-select" aria-label="Default select example">
                                        <option selected>Front Only</option>
                                        <option value="1">Front Left Chest Only</option>
                                        <option selected>Front / Back</option>
                                        <option value="1">Left Chest / Back</option>
                                    </select>
                                </div>

                                <div class="quote-filed">
                                    <label>If our template, please provide SKU#</label>
                                    <input class="input-box" placeholder="If our template, please provide SKU#">
                                </div>
                                <p>If you need more information about one of our products, please provide the SKU #
                                    located under the product information beside the product image.</p>

                                <div class="quote-filed chosef-file">
                                    <label>File</label>
                                    <input class="input-box" type="file">
                                    <p>Accepted file types: jpg, png, pdf, gif, docx, jpeg, Max. file size: 25 MB, Max.
                                        files: 2.</p>
                                </div>
